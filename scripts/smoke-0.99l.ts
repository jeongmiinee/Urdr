...
assert(PROGRAM_VERSION === "0.99l-3", "program version mismatch");
assert(UPDATE_HISTORY[0]?.version === "0.99l-3", "latest update history entry missing");
...
assert(staticDemo.version === "0.99l-3", "static demo version mismatch");
...
assert(normalized.version === "0.99l-3", "migration version mismatch");
