...
console.log(JSON.stringify({
  ...
  riverMouths: generated.rivers.filter((river) => river.mouth).length,
  riverNodeSettings: { count: generated.settings.riverNodeCount, maxElevation: generated.settings.riverNodeMaxElevation },
