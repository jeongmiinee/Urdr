...
export function ReferencePicker({ label, options, articleId, customText, allowNone = true, onChange }: { label: string; options: ReferenceOption[]; articleId?: string; customText?: string; allowNone?: boolean; onChange: (value: { articleId?: string; customText?: string; mode: "selected" | "custom" | "undecided" | "none" }) => void }) {
